...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_expr_stmt = 27,                 /* expr_stmt  */
...
{
       0,    38,    38,    40,    44,    45,    49,    55,    56,    57,
      58,    62,    63,    67,    76,    92,    96,   108,   109,   110,
     111,   112,   116,   126,   129,   132,   133
};
#endif
...
static const char *const yytname[] =
{
  ...
  "IDENT", "INT_CONST", "FLOAT_CONST", "ASSIGN", "SEMI", "LPAREN",
  "RPAREN", "PLUS", "MINUS", "MUL", "DIV", "UNKNOWN", "DOUBLE", "','",
  "$accept", "program", "stmt", "declaration", "type", "varlist",
  "var_decl", "expr_stmt", "expr", "factor", YY_NULLPTR
};
...
{
     -23,    19,   -23,   -23,   -23,   -23,    -4,   -23,   -23,    -5,
     -23,   -23,   -23,   -23,     1,   -23,    18,   -23,    -5,    26,
      -1,    -6,   -23,   -23,    -5,    -5,    -5,    -5,    30,   -23,
      -5,   -23,     1,    30,    30,    30,    30,    30,   -23
};
...
{
       2,     0,     1,     7,     8,     9,    22,    23,    24,     0,
      26,    10,     3,     4,     0,     5,     0,    21,     0,     0,
      13,     0,    11,    15,     0,     0,     0,     0,    16,    25,
       0,     6,     0,    17,    18,    19,    20,    14,    12
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -23,   -23,   -23,   -23,   -23,   -23,   -22,   -23,    -9,   -23
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,    12,    13,    14,    21,    22,    15,    16,    17
};
...
{
      19,     6,     7,     8,    31,    18,     9,    20,    30,    28,
      38,     0,    10,    32,     0,    33,    34,    35,    36,     2,
       0,    37,     3,     4,     5,     6,     7,     8,    23,     0,
       9,    24,    25,    26,    27,     0,    10,    11,    29,    24,
      25,    26,    27,    24,    25,    26,    27
};

static const yytype_int8 yycheck[] =
{
       9,     6,     7,     8,    10,     9,    11,     6,     9,    18,
      32,    -1,    17,    19,    -1,    24,    25,    26,    27,     0,
      -1,    30,     3,     4,     5,     6,     7,     8,    10,    -1,
      11,    13,    14,    15,    16,    -1,    17,    18,    12,    13,
...
static const yytype_int8 yystos[] =
{
      ...
      17,    18,    22,    23,    24,    27,    28,    29,     9,    28,
       6,    25,    26,    10,    13,    14,    15,    16,    28,    12,
       9,    10,    19,    28,    28,    28,    28,    28,    26
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* declaration: type varlist SEMI  */
#line 49 "parser.y"
                      {
...
#line 1117 "parser.tab.c"
  ...
  case 7: /* type: INT  */
#line 55 "parser.y"
           { (yyval.str) = strdup("int"); last_type = (yyval.str); }
#line 1123 "parser.tab.c"
    break;

  case 8: /* type: FLOAT  */
#line 56 "parser.y"
            { (yyval.str) = strdup("float"); last_type = (yyval.str); }
#line 1129 "parser.tab.c"
    break;

  case 9: /* type: CHAR  */
#line 57 "parser.y"
            { (yyval.str) = strdup("char"); last_type = (yyval.str); }
#line 1135 "parser.tab.c"
    break;

  case 10: /* type: DOUBLE  */
#line 58 "parser.y"
             { (yyval.str) = strdup("double"); last_type = (yyval.str); }
#line 1141 "parser.tab.c"
    break;

  case 13: /* var_decl: IDENT  */
#line 67 "parser.y"
          {
        Type t = TYPE_UNKNOWN;
        ...
        symtab_insert((yyvsp[0].str), t);
        free((yyvsp[0].str));
    }
#line 1155 "parser.tab.c"
    break;

  case 14: /* var_decl: IDENT ASSIGN expr  */
#line 76 "parser.y"
                        {
        Type t = TYPE_UNKNOWN;
        if (strcmp(last_type, "int")==0) t = TYPE_INT;
        ...
        if (t != last_expr_type && last_expr_type != TYPE_UNKNOWN) {
            printf("Error semántico (línea %d): inicialización incompatible para '%s' (esperado %s, encontrado %s)\n",
                   yylineno, (yyvsp[-2].str), type_to_string(t), type_to_string(last_expr_type));
        }
        free((yyvsp[-2].str));
    }
#line 1173 "parser.tab.c"
  ...
  case 15: /* expr_stmt: expr SEMI  */
#line 92 "parser.y"
              { }
#line 1179 "parser.tab.c"
    break;

  case 16: /* expr: IDENT ASSIGN expr  */
#line 96 "parser.y"
                      {
        Symbol *s = symtab_lookup((yyvsp[-2].str));
        if (!s) {
            ...
            if (s->type != last_expr_type && last_expr_type != TYPE_UNKNOWN) {
                printf("Error semántico (línea %d): asignación de tipo incompatible a '%s' (esperado %s, encontrado %s)\n",
                       yylineno, (yyvsp[-2].str), type_to_string(s->type), type_to_string(last_expr_type));
            }
        }
        free((yyvsp[-2].str));
    }
...
#line 116 "parser.y"
          {
        Symbol *s = symtab_lookup((yyvsp[0].str));
        if (!s) {
